function [ kgi] = cKG1Dis(parameters,  mu, sigma, i )
%cKG1Dis
...
%%
    ...
    %exponential kgi
    kgi = exp(parameters.delta*sum(temp))/(exp(parameters.c(i)/parameters.P)*exp((1-parameters.delta)*a(g0)));
end