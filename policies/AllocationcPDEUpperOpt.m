function [ i ] = AllocationcPDEUpperOpt( undissoln, dissoln, parameters, muin, sigmain, randtype, randprob )
%AllocationcPDEUpperOpt
% PURPOSE: Implements the allocation policy cPDEUpper defined in Chick, Gans,
% Yapar (2020) with optimized weights. Returns the index of the arm to be 
