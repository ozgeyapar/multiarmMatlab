function [ stop ] = StoppingcPDEUpperNoOpt( undissoln, dissoln, parameters, muin, sigmain )
%StoppingcPDEUpperNoOpt
% PURPOSE: Implements the stopping time cPDEUpper defined in Chick, Gans,
% Yapar (2020) with equal weights. Returns 1 for stopping and 0 for
% continue.
%
% INPUTS: 
