SETUP
	...
	5. Open Matlab and make multiarmMatlab folder the current directory.
	6. Run SetSolFiles.m, which creates the standardized PDE solution files to be used in cPDELower and cPDEUpper policies. This step is needed to run only once per machine.
