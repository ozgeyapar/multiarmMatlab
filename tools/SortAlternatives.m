function [a,b] = SortAlternatives(a,b)
%SortAlternatives
% PURPOSE: Reorders both vectors so that b is in ascending order, and 
% removes elements with duplicate b values.
%
% INPUTS: 
% a,b: numerical vectors
%
% OUTPUTS: 
% a,b: processed and orders vectors
%
%%
