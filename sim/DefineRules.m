...
aCKGstarold = @(undissoln, dissoln,parameters,  muin,sigmain, t, randtype, randprob) AllocationcKGstar( parameters, muin, sigmain, randtype, randprob );
aCKGstar = @(undissoln, dissoln,parameters,  muin,sigmain, t, randtype, randprob) AllocationcKGstarRatio( parameters, muin, sigmain, randtype, randprob );
...
sCKGstarold = @(undissoln, dissoln, parameters, muin,sigmain,Tfixed,t) StoppingcKGstar( parameters, muin, sigmain );
sCKGstar = @(undissoln, dissoln, parameters, muin,sigmain,Tfixed,t) StoppingcKGstarRatio( parameters, muin, sigmain );
